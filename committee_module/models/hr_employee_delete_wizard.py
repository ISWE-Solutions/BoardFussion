...
class HrEmployeDeleteWizard(models.TransientModel):
    _inherit = 'hr.employee.delete.wizard'

    employee_ids = fields.Many2many('hr.employee', string='Members', context={'active_test': False})
    has_active_employee = fields.Boolean(string='Has Active Member', compute='_compute_has_active_employee')
